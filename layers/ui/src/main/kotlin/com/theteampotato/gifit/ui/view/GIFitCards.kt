...
@Composable
fun GIFitLanguageCard(text: String, painter: Painter, isSelected: Boolean, onClicked: () -> Unit = {}, contentDescription: String = "") {
    val horizontalPadding = 25.dp
    ...
    Card(
        ...
        backgroundColor = if (isSelected) babyBlue else Color.White
    )
    {
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            Text(color = if (isSelected) Color.White else Color.Black, fontWeight = FontWeight.Bold, textAlign = TextAlign.Center, text = text)
        }
        Image(modifier = Modifier.padding(20.dp), painter = painter, contentDescription = contentDescription, alignment = Alignment.CenterStart)
    }
}
